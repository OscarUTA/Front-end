...
const Register = () => {
  ...
  const { nombre, contraseña, contraseña2, correo } = inputs;
  ...
  const onSubmit = async (e) => {
    ...
    if (nombre !== "" && contraseña !== "" &&  contraseña2 !== ""   &&  correo !== "") {
      const Usuario = {
        nombre,
        correo,
        contraseña,
      ...
      await axios
        ...
        .then((res) => {
          ...
          setInputs({ nombre: "", contraseña: "",  contraseña2: "",correo: "" });
          setTimeout(() => {
            setMensaje("");
            navigate("/");
          }, 1500);
    ...
    <>
      <div className={styles.formContainer}>
        ...
        <form onSubmit={(e) => onSubmit(e)}>
          ...
          <div className={styles.inputContainer}>
            <div className={styles.left}>
              <label htmlFor="contraseña2">Contraseña2</label>
              <input
                onChange={(e) => HandleChange(e)}
                value={contraseña2}
                name="contraseña2"
